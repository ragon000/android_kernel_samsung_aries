...
// DVS INT
#define DVSINT0 1175000 // 1400 MHz
#define DVSINT1 1150000 // 1300 MHz
#define DVSINT2 1125000 // 1100, 1200 MHz
#define DVSINT3 1100000 // 200, 400, 800, 1000 MHz
#define DVSINT4 1000000 // 100 MHz
